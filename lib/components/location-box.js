        ...
        navigator.geolocation.getCurrentPosition(function(position) {
          ...
          $.getJSON(url, (place) => {
            ...
            suggestion.display =
              ...
              'Current location';
            suggestion.display = suggestion.display.replace(' City', '').replace('City of ', '').replace(' and ', ' & ');
            suggestion.district = result.admin_district[0].replace(' City', '').replace('City of ', '').replace(' and ', ' & ');
            suggestion.county = result.admin_district[0].replace(' City', '').replace('City of ', '').replace(' and ', ' & ');
