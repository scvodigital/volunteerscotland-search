...
export class MapClusteredComponent {
    constructor(mapContainer) {
        ...
        const regionZoomLimit = this.options.regionZoom || 7; // At and below this zoom we draw region maps. Highlands is so big, this needs to be 7.
        const initialZoom = this.options.query.lat ? 9 : 7;
        ...
        const PADDING = 1; // How far outside the bounds shown do we get results?
        ...
        var loadMarkers = (thenFunction) => {
            ...
            this.queryBounds = this.map.getBounds();
