    ...
    initialise() {
        ...
        $('[data-collapse-target]').off('click').on('click', (evt) => {
            ...
            if ($target.is(':visible')) {
                $target.hide();
                // $caption.show();
                $icon.removeClass('fa-chevron-up').addClass('fa-ellipsis-h');
                // If you are yourself a
                $el.removeClass('fa-chevron-up').addClass('fa-ellipsis-h');
            } else {
                $target.show();
                // $caption.hide();
                $icon.removeClass('fa-ellipsis-h').addClass('fa-chevron-up');
                $el.removeClass('fa-ellipsis-h').addClass('fa-chevron-up');
